...
def gerar_proposta_html(dados):
    ...
    # ... (Seu código original de geração HTML continua aqui)
    return "" # Substitua por seu código original completo

# --- INTERFACE PRINCIPAL ---
# (Aqui entra a sua interface original que você já tinha, 
# apenas mantendo a correção para ler os dados do state como definido abaixo)

# Dica de correção para o botão:
# dados = {
